...
#### 1.3 Payment Methods – Manual Invoice (Enhancements)
...
- ✅ Manual payment entry form (`src/components/PayNowModal/index.tsx`)
- ✅ Payment proof upload UI (base64 image upload working)
- ✅ Basic validation working
- ✅ Form submission working

##### ❌ Frontend - What's Pending:

- ❌ Dashboard updates UI (auto-refresh payment status)
- ❌ Payment proof preview component
- ❌ Payment timeline display
...
**Step 1: Dashboard Updates**

- WebSocket notifications when admin approves/rejects
- Real-time payment status updates
- Broadcast to user when payment status changes
...
- `src/services/notification.service.ts` (ENHANCE or CREATE)

**API Endpoints**:

```
WebSocket: payment-status-updates channel - Real-time status updates
POST /api/notifications/payment-status - Send notification (optional)
```
...
- `src/components/NotificationBadge/index.tsx` (NEW)
- `src/components/PaymentTimeline/index.tsx` (NEW)
...
- [ ] Auto-refresh payment status
- [ ] Show payment proof preview component
- [ ] Display payment timeline
